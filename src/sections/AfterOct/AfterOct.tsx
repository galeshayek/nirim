...
const AfterOct = () => {
  ...
  return (
    <section
      id="about"
      className="m-auto flex flex-col gap-y-5 pt-10 mx-3 md:mx-10 px-4 md:px-20 xl:px-44 items-center border-l-[2rem] border-pop"
    >
      <Title>{t("afterOct.sectionTitle")}</Title>
      <p
        dir={i18next.dir()}
        className="leading-8 md:text-justify px-5 md:px-14"
      >
        <span className="font-bold">{t("afterOct.title")}</span>
        {t("afterOct.p")}
      </p>

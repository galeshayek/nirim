          ...
          projects: {
            educational: {
              kinderGarden: {
                ...
                text2:
                  "The budget encompasses building renovation, adding two new kindergarten classes, kindergarten and yard equipment",
              },
              activities: {
                title: "Educational activities",
                text1:
                  "Creating an array of informal education activities for kids and teenagers",
                budget: "       Total Project Budget: $100,000",
              },
              youthClab: {
                title: "Youth Club",
                text1:
                  "After the existing structure was infiltrated and severely damaged by the terrorists on October 7th, our teens’ club needs to be restored, expanded and upgraded.",
            ...
            health: {
              therapies: {
                ...
                text1:
                  "Complementary treatment and therapies for victims of 7/10",
                budget: "Per year: $100,000",
              },
              sportsCenter: {
                title: " A Sports Center for Children and Youth",
                text1:
                  "The new sports center for children and youth in Nirim will provide a safe and enjoyable environment, as well as physical and emotional treatment and rehabilitation",
                text2:
                  "The center will cater to individual and group activities and will be supervised by certified professionals and trainers.",
            ...
            community: {
              colorfulPlayground: {
                ...
                text1:
                  "Providing the children of the kibbutz with an inviting and enjoyable play space and a fun meeting place for children and young parents",
                ...
                budget: "  Total Project Budget: $600,000",
              },
              diningHall: {
                title:
                  "Renovation and protective reinforcement of the dining hall and the Grocery Store",
                text1:
                  "Kibbutz Nirim is situated so close to the border, that they are exposed to mortar as well as rocket fire. When there is an incoming alert, people only have between 0-10 seconds to get to a protected area.",
                highlight1: "A kibbutz's communal dining room",
                text2:
                  " is the community's heart and soul. Nirim’s dining hall is too small to accommodate all the community members; therefore, community-wide events and activities, holiday meals, and shared Friday evening meals are held on the kibbutz lawns in the open air. ",
                highlight2:
                  "Moving the kibbutz dining room to a spacious and protected space",
                text3:
                  "Will allow the entire community to gather safely and celebrate holidays together, hold joint Friday meals and community events, even in difficult, tense times.",
              },
              groceryStore: {
                title: "Nirim’s grocery store",
                text1:
                  "Serves the residents of Nirim and the surrounding communities. Customers and staff must run to the nearest protected place outside the store during emergencies.",
                text2:
                  "The new grocery store will be built on the upper floor of the two-story dining hall building. The complex will allow the expansion of the grocery area and the construction of a more innovative system that will provide more efficient service to the kibbutz residents and the residents of the nearby communities. ",
                text3:
                  "The budget encompasses building renovation, purchasing equipment and furniture for the dining room,  adapting the structure for storing and cooling food products for the grocery store",
                budget:
                  "The total budget needed for the dining hall and grocery store: $1,000,000",
              },
              communityGarden: {
                title: "Community Garden",
                text1:
                  "Upgrading and expanding the community Garden into an experiential space for joint activities for parents and children, including a Bedouin tent and tabun oven",
                budget: "Total Project Budget $80,000 ",
              },
              pool: {
                title: "Swimming Pool Restoration",
                text1:
                  "Transform the existing swimming pool into a community hub, enhancing its utility and accessibility year-round.",
                subtitle:
                  "The budget encompasses Renovations and Enhancements:",
                ul: {
                ...
                budget: "Total Project Budget: $70,000",
              },
            },
            infrastructure: {
              dairy: {
                ...
                text2:
                  "The restoration and upgrading of the cowshed will allow an increase of 700,000 liters (185,000 gallons) in the annual milk quota, strengthening the economic resilience of the kibbutz and of the entire Western Negev region",
              ...
              reservoir: {
                ...
                subtitle:
                  "Was established in the Western Negev region as part of the fulfillment of David Ben-Gurion's Zionist dream “To develop the Negev and make the desert bloom”",
                text1:
                  "Nirim’s Reservoir collects floodwater from the Besor River during the rainy season to provide irrigation for the agricultural fields of Kibbutz Nirim during the dry months.",
                ul: {
                ...
                text2:
                  "Establishing the water reservoir leased to the State of Israel will generate an annual income of $410,000 for Kibbutz Nirim. The State has committed to a 15-year lease agreement, enhancing the kibbutz’s financial stability.",
                text3:
                  "The budget encompasses constructing a 3 km-long water pipeline, a pump complex with remote control, a leasing system for the State of Israel, filtration, chlorination, and water control. In addition, fencing infrastructure, safety, permits, and planners are included.",
      ...
      he: {
        translation: {
          ...
          hero: {
            ...
            text: `נוסד בשנת 1946, מהישובים הראשונים שהוקמו באזור הנגב המערבי, כחלק מחזון בן גוריון ליישב את הנגב ולהפריח את השממה.
...
`,
          ...
          needs: {
            ...
            subtitle:
              "תרומתכם תסייע לנו לקדם מיזמים שיאפשרו לקהילת נירים לבנות את חייהם מחדש",
            ul: {
              li1: {
                subtitle: "חינוך:",
          ...
          projects: {
            educational: {
              kinderGarden: {
                ...
                needed: "תקציב נדרש: $650,000",
                text2:
                  "התקציב כולל שיפוץ מבנים, הוספת שתי כיתות גן חדשות, ציוד גן וחצר",
              },
              activities: {
                title: "פעילויות חינוכיות",
                text1:
                  "יצירת מערך לקידום פעילויות חינוכיות ויסיוע בצמצום פערים לימודיים עבור ילדים ובני נוער",
                budget: "תקציב נדרש: $100,000",
              },
              youthClab: {
                title: "בניית מועדון נוער:",
                text1:
                  ' בית הנוער הישן של הקיבוץ נפגע מפגיעות פצמ"רים ומועמד להריסה',
            ...
            health: {
              therapies: {
                ...
                text1:
                  "יצירת מעטפת טיפולית משלימה הכוללת טיפולים רפואיים ופרה-רפואיים עבור נפגעי ה 7.10",
              ...
              sportsCenter: {
                ...
                text2:
                  "מרכז הספורט החדש לילדים ונוער בקיבוץ נירים יעניק סביבה בטוחה ומהנה, כמו גם טיפול ושיקום פיזי ורגשי. במרכז יתקיימו פעילויות אישיות וקבוצתיות בליווי ופיקוח אנשי מקצוע ומאמנים מוסמכים.",
            ...
            community: {
              colorfulPlayground: {
                title: "הקמת גן שעשועים חדש וצבעוני עבור ילדי הקיבוץ",
                text1:
                  "יאפשר לילדי הקיבוץ מרחב משחק מזמין ומהנה ומקום מפגש בטוח עבור ילדים ומשפחות צעירות",
                ...
                budget: "תקציב הפרויקט: $600,000",
              },
              diningHall: {
                title: "שיפוץ וחיזוק מיגון חדר האוכל והמכולת",
                text1:
                  "בשל קרבתו של הקיבוץ לגבול, הגעה למקום בטוח בזמן אזעקה היא בין 0 ל-10 שניות.",
                highlight1: "חדר אוכל משותף של קיבוץ",
                text2:
                  "הוא הלב והנשמה של הקהילה. חדר האוכל של נירים קטן מכדי להכיל את כל חברי הקהילה; לפיכך, אירועים ופעילויות כלל קהילתיים, ארוחות חג וארוחות שישי משותפות מתקיימים במדשאות הקיבוץ באוויר הפתוח.",
                highlight2: "העברת חדר האוכל של הקיבוץ לחלל מרווח ומוגן",
                text3:
                  "יאפשר לכל הקהילה להתכנס בבטחה ולחגוג יחד חגים, לערוך ארוחות שישי משותפות ואירועים קהילתיים, גם בזמנים קשים ומתוחים.",
              },
              groceryStore: {
                title: "המכולת של נירים",
                text1:
                  "משרת את תושבי נירים וישובי הסביבה. לקוחות וצוות חייבים לרוץ למקום המוגן הקרוב ביותר מחוץ לחנות בשעת חירום.",
                text2: "",
                text3:
                  "המכולת החדשה תוקם בחנות העליונה של בניין חדר האוכל. המתחם יאפשר את הרחבת שטח המכולת ובניית מערך חדשני יותר שייתן שירות יעיל יותר לתושבי הקיבוץ ולתושבי הישובים הסמוכים.",
              ...
              pool: {
                ...
                text1:
                  "בריכת השחייה והמדשאות שמסביב מהווים מקום בילוי מרכזי עבור ילדי הקיבוץ במהלך חודשי הקיץ ומקום בילוי מרכזי עבור הקהילה כולה.",
            ...
            infrastructure: {
              dairy: {
                ...
                text2:
                  "שיקום ושדרוג הרפת יאפשר הגדלה של 700,000 ליטר (185,000 גלונים) במכסת החלב השנתית, ויתרום בצורה משמעותית לחיזוק החוסן הכלכלי של הקיבוץ ושל אזור הנגב המערבי כולו.",
              ...
              reservoir: {
                ...
                text1:
                  "מאגר המים של קיבוץ נירים הוקם בשנות ה 70 כדי לאגור מים מנחל הבשור במהלך החודשים הגשומים ולספק מי השקיה לשדות החקלאיים של קיבוץ נירים בחודשי הקיץ היבשים ובתקופות של בצורת.",
                ul: {
                ...
                text2:
                  "בימים אלה מדינת ישראל מבקשת לחבר את מאגר המים של קיבוץ נירים לצינורות המים האזוריים כדי לאפשר לקיבוצים וישובים נוספים באזור שימוש במי המאגר להשקיית השדות החקלאיים שלהם. בתמורה, המדינה תעניק לנירים חוזה שכירות לתקופה של 15 שנים, במסגרתו תשלם לקיבוץ סכום שנתי של $400,000",
                text3:
                  'התקציב כולל: הקמת צינור באורך 3 ק"מ, הקמת מתחם מערכת משאבות נשלט מרחוק, התקנת מערכת סינון, טיהור ובקרת איכות של המים וכן התקנת גידור ומערכת אבטחה של מאגר המים.',

            ...
            he: {
                translation: {
                    ...
                    hero: {
                        ...
                        text: `קיבוץ נירים נוסד בשנת 1946, מהישובים הראשונים שהוקמו באזור הנגב המערבי, כחלק מחזון בן גוריון ליישב את הנגב ולהפריח את הדממה.
                    ...
                    needs: {
                        ...
                        ul: {
                            ...
                            li3: {
                                ...
                                text: 'הקמת תשתיות ומרחבים שיאפשרו מפגשים ופעילויות קהילתיות בסביבה בטוחה ונעימה ויעניקו לקהילה את האפשרות לייצר שוב אינטראקציות קהילתיות וחוויות מעצימות וחיוביות ופיתוח מיזמים עסקיים וחיזוק תשתיות כלכליות לחיזוק החוסן הכלכלי של הקיבוץ ',
                            },
                            li4: {
                                subtitle: 'קידום תשתיות ',
                                text: 'חיזוק הקיימות הכלכלית והסביבתית באמצעות פרויקטי תשתית אסטרטגיים כמו הרחבת רפת ובנייה מחדש של מאגרים, הפקת הכנסות והבטחת משאבים.',
                            },
                            link: 'לעוד מידע... '
                        },
                    },
                    cta: {
                        text2: "יש לנו כמה פרויקטים משפיעים הזקוקים למימון. אנא אל תהססו לפנות אלינו אם אתם מעוניינים לתמוך ביוזמות שלנו!",
                    ...
                    projects: {
                        educational: {
                            ...
                            activities: {
                                ...
                                text1: 'יצירת מערך לקידום פעילויות חינוכיות ויסיוע בצמצום פעלים לימודיים עבור ילדים ובני נוער',
                        ...
                        health: {
                            ...
                            sportsCenter: {
                                ...
                                ul: {
                                    ...
                                    li2: 'קיר טיפוס ברמות קושי שונות 100,000$',
                                    li3: `מתחם ג'ימבורי ייעודי עבור פעוטות 50,000$`,
                                },
                                budget: 'תקציב הפרוייקט 350,000$'
                            },
                        },
                        community: {
                            colorfulPlayground: {
